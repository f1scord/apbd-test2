...
namespace ApbdTestf.Migrations
{
    ...
    [Migration("20260602115143_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApbdTestf.Entities.Concert", b =>
                {
            ...
            modelBuilder.Entity("ApbdTestf.Entities.Customer", b =>
                {
            ...
            modelBuilder.Entity("ApbdTestf.Entities.PurchasedTicket", b =>
                {
            ...
            modelBuilder.Entity("ApbdTestf.Entities.Ticket", b =>
                {
            ...
            modelBuilder.Entity("ApbdTestf.Entities.TicketConcert", b =>
                {
                    b.Property<int>("TicketConcertId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApbdTestf.Entities.PurchasedTicket", b =>
                {
                    b.HasOne("ApbdTestf.Entities.Customer", "Customer")
                        .WithMany("PurchasedTickets")
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ApbdTestf.Entities.TicketConcert", "TicketConcert")
                        .WithMany("PurchasedTickets")
            ...
            modelBuilder.Entity("ApbdTestf.Entities.TicketConcert", b =>
                {
                    b.HasOne("ApbdTestf.Entities.Concert", "Concert")
                        .WithMany("TicketConcerts")
                        .HasForeignKey("ConcertId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ApbdTestf.Entities.Ticket", "Ticket")
                        .WithMany("TicketConcerts")
